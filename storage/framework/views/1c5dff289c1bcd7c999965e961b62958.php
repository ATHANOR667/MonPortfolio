<div>
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6 transition-all duration-300">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Expérience professionnelle</h2>
            <button type="button" wire:click="toggleForm" class="py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-300">
                <?php echo e($showForm ? 'Annuler' : 'Ajouter une expérience'); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($showForm): ?>
            <div class="mb-6 p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
                    <?php echo e($isEditing ? 'Modifier l\'expérience' : 'Ajouter une expérience'); ?>
                ...
                <form wire:submit.prevent="save">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" id="company" wire:model="company" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['company'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            <label for="position" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Poste</label>
                            <input type="text" id="position" wire:model="position" required class="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-md focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:text-white <?php $__errorArgs = ['position'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div class="mb-4">
                        <div class="flex items-center">
                            ...
                            <label for="is_current" class="ml-2 block text-sm text-gray-700 dark:text-gray-300">Poste actuel</label>
                        </div>
                    </div>
        ...
        <div class="space-y-6">
            <!--[if BLOCK]><![endif]--><?php if($experiences->isEmpty()): ?>
                <p class="text-gray-500 dark:text-gray-400 text-center py-4">Aucune expérience ajoutée pour le moment.</p>
            <?php else: ?>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $experiences; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border-b border-gray-200 dark:border-gray-700 pb-6 last:border-0 last:pb-0">
                        <div class="flex justify-between items-start">
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white"><?php echo e($exp->position); ?></h3>
                                <p class="text-gray-600 dark:text-gray-400"><?php echo e($exp->company); ?></p>
                                <p class="text-sm text-gray-500 dark:text-gray-500">
                                    <?php echo e(\Carbon\Carbon::parse($exp->start_date)->format('M Y')); ?> - 
                                    <!--[if BLOCK]><![endif]--><?php if($exp->is_current): ?>
                                        Présent
                                    <?php else: ?>
                                        <?php echo e($exp->end_date ? \Carbon\Carbon::parse($exp->end_date)->format('M Y') : 'Non spécifié'); ?>

                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <!--[if BLOCK]><![endif]--><?php if($exp->location): ?>
                                        · <?php echo e($exp->location); ?>

                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                </p>
                                <!--[if BLOCK]><![endif]--><?php if($exp->description): ?>
                                    <p class="text-gray-600 dark:text-gray-400 mt-2"><?php echo e($exp->description); ?></p>
                                <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            </div>
                            <div class="flex space-x-2">
                                <button type="button" wire:click="edit(<?php echo e($exp->id); ?>)" class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                                <button type="button" wire:click="delete(<?php echo e($exp->id); ?>)" wire:confirm="Êtes-vous sûr de vouloir supprimer cette expérience ?" class="p-2 text-red-500 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\MonPortfolio\resources\views/livewire/profile-experience.blade.php ENDPATH**/ ?>