...
<div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($totalVisits); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($totalProjects); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="flex items-center">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($totalComments); ?></p>
                        <?php if($pendingComments > 0): ?>
                            <span class="ml-2 px-2 py-1 text-xs rounded-full bg-yellow-100 text-yellow-800 dark:bg-yellow-900 dark:text-yellow-300"><?php echo e($pendingComments); ?> en attente</span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300">
            <div class="flex items-center">
                ...
                <div class="ml-4">
                    ...
                    <div class="flex items-center">
                        <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($totalMessages); ?></p>
                        <?php if($unreadMessages > 0): ?>
                            <span class="ml-2 px-2 py-1 text-xs rounded-full bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-300"><?php echo e($unreadMessages); ?> non lu(s)</span>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                    ...
                    <?php $__currentLoopData = $topProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="flex items-center justify-between">
                            <div class="flex items-center">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('admin.projects.edit', $project)); ?>" class="text-gray-900 dark:text-white hover:text-primary-600 dark:hover:text-primary-400 truncate max-w-[150px]"><?php echo e($project->title); ?></a>
                            </div>
                            <span class="px-2 py-1 text-xs rounded-full bg-primary-100 text-primary-800 dark:bg-primary-900 dark:text-primary-300"><?php echo e($project->views_count); ?> vues</span>
                        </li>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 transition-all duration-300">
            ...
            <?php if($visitorsByCountry->isEmpty()): ?>
                <p class="text-gray-500 dark:text-gray-400">Aucune donnée disponible</p>
            <?php else: ?>
                <div class="space-y-4">
                    <?php $__currentLoopData = $visitorsByCountry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center">
                            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4">
                                <div class="bg-primary-600 dark:bg-primary-500 h-4 rounded-full" style="width: <?php echo e(($visitor->count / $visitorsByCountry->max('count')) * 100); ?>%"></div>
                            </div>
                            <span class="ml-3 text-sm text-gray-700 dark:text-gray-300 min-w-[100px]"><?php echo e($visitor->country); ?> (<?php echo e($visitor->count); ?>)</span>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            <?php endif; ?>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                            <?php $__currentLoopData = $recentVisitors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visitor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($visitor->ip); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($visitor->country ?? 'Inconnu'); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($visitor->page); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400"><?php echo e($visitor->created_at->diffForHumans()); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MARCAU\PhpstormProjects\MonPortfolio\resources\views/admin/statistics/index.blade.php ENDPATH**/ ?>