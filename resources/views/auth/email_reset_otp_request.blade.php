...
@section('title', 'Modification de l\'email - Demande OTP')
    ...
    <div class="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md transition-all duration-300">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                Veuillez entrer votre nouvelle adresse email et confirmer avec votre mot de passe actuel
            </p>
        </div>
        ...
        <form class="mt-8 space-y-6" method="POST">
            ...
            <div class="rounded-md space-y-4">
                <div>
                    <label for="email" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nouvelle adresse email</label>
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Mot de passe actuel</label>
