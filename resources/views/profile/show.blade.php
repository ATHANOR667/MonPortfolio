        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 mb-10 fade-in">
            <div class="flex flex-col md:flex-row items-center md:items-start gap-10">
                <div class="w-56 h-56 rounded-full overflow-hidden bg-gray-200 dark:bg-gray-700 flex-shrink-0 shadow-md border-4 border-white dark:border-gray-700">
                    @if($profile->photo)
                        <img src="{{ Storage::url($profile->photo) }}" alt="{{ $profile->full_name }}" class="w-full h-full object-cover">
                    @else
                ...
                <div class="flex-1 text-center md:text-left">
                    <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-3">{{ $profile->full_name }}</h1>
                    
                    @if($profile->title)
                        <p class="text-2xl text-primary-600 dark:text-primary-400 mb-5">{{ $profile->title }}</p>
                    @endif
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        @if($profile->email)
                            <a href="mailto:{{ $profile->email }}" class="inline-flex items-center text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-300">
                        ...
                        @if($profile->phone)
                            <a href="tel:{{ $profile->phone }}" class="inline-flex items-center text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        @if($profile->website)
                            <a href="{{ $profile->website }}" target="_blank" class="inline-flex items-center text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex flex-wrap gap-4 mb-6 justify-center md:justify-start">
                        @if($profile->linkedin)
                            <a href="{{ $profile->linkedin }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 rounded-md bg-blue-600 text-white hover:bg-blue-700 transition-colors duration-300">
                        ...
                        @if($profile->github)
                            <a href="{{ $profile->github }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 rounded-md bg-gray-800 text-white hover:bg-gray-900 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($profile->twitter)
                            <a href="{{ $profile->twitter }}" target="_blank" class="inline-flex items-center justify-center px-4 py-2 rounded-md bg-blue-400 text-white hover:bg-blue-500 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($profile->cv_path)
                        <div class="mt-6">
                            <a href="{{ Storage::url($profile->cv_path) }}" target="_blank" class="inline-flex items-center py-3 px-6 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <div class="mb-10 ml-10">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                                <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                                    <div>
                                        <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $exp->position }}</h3>
                                        <p class="text-xl text-primary-600 dark:text-primary-400">{{ $exp->company }}</p>
                                    </div>
                    ...
                    @foreach($education as $edu)
                        <div class="mb-10 ml-10">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
                                <div class="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                                    <div>
                                        <h3 class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $edu->degree }}</h3>
                                        <p class="text-xl text-primary-600 dark:text-primary-400">{{ $edu->institution }}</p>
                                    </div>
                                    <div class="mt-2 md:mt-0 text-sm font-medium text-gray-500 dark:text-gray-400 md:text-right">
                                        <p class="inline-flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            @if($edu->is_current)
                                                <span class="text-primary-600 dark:text-primary-400 font-semibold">Présent</span>
                                            @else
                                                {{ $edu->end_date ? \Carbon\Carbon::parse($edu->end_date)->format('M Y') : 'Présent' }}
                                            @endif
                                        </p>
                                        @if($edu->location)
                                            <p class="inline-flex items-center mt-1">
