                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @foreach($comments as $comment)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-200 comment-row" data-comment-id="{{ $comment->id }}">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="{{ route('admin.projects.edit', $comment->project) }}" class="text-primary-600 hover:text-primary-900 dark:text-primary-400 dark:hover:text-primary-300">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <div class="flex justify-end space-x-2">
                                        <button type="button" class="view-comment-btn text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300" data-comment-id="{{ $comment->id }}">
