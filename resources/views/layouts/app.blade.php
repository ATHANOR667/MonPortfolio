                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <div class="flex space-x-4">
                            @php
                                $linkedin = \App\Models\User::first()?->profile?->linkedin;
                                $github = \App\Models\User::first()?->profile?->github;
                            @endphp

                            @if($linkedin)
                                <a href="{{$linkedin}}" class="text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400 transition-colors duration-300">
                            ...
                            @if($github)
                                <a href="{{$github}}" class="text-gray-500 hover:text-primary-600 dark:text-gray-400 dark:hover:text-primary-400 transition-colors duration-300">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-start">
                                ...
                                @php
                                    $email = \App\Models\User::first()?->profile?->email;
                                @endphp

                                @if($email)
                                    <a href="mailto:{{ $email }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                                        {{ $email }}
                                    </a>
                                @endif
                            </li>
                            <li class="flex items-start">
                                ...
                                @php
                                    $phone = \App\Models\User::first()?->profile?->phone;
                                @endphp

                                @if($phone)
                                    <a href="tel:{{ $phone }}" class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">
                                        {{ $phone }}
                                    </a>
                                @endif
                            </li>
                            <li class="flex items-start">
                                ...
                                @php
                                    $location = \App\Models\User::first()?->profile?->location;
                                @endphp
                                @if($location)
